...
const vehicles = [
  {
    ...
    rating: 5,
    description:
      "Vehículo seguro y moderno, ideal para la enseñanza práctica en escuelas de conducción.",
  },
  {
    id: 2,
...
export default function VehicleCarousel() {
  ...
  const getCardClass = (index) => {
    ...
    if (
      index === centerIndex - 1 ||
      (centerIndex === 0 && index === vehicles.length - 1)
    )
      return "vehicle-card previous";
    if (
      index === centerIndex + 1 ||
      (centerIndex === vehicles.length - 1 && index === 0)
    )
