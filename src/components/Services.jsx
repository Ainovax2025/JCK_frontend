...
const services = [
    ...
    { id: 4, name: "Re-categorización B1 a C1", description: "Proceso de actualización para conductores de transporte público.", src: image4 },
            ...
            <div className="services-container">
                {services.map((service) => (
                    <div key={service.id} className="service-card" style={{ backgroundColor: "#D2D4D4" }}>
                        <img src={service.src} alt={service.name} className="service-image" style={{mixBlendMode: "multiply"}} />
